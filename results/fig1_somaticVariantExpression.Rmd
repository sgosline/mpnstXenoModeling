...
pheatmap(log10(0.01+mutMat),clustering_distance_cols = 'correlation',cellwidth = 10,annotation_col = annotes,labels_row = rep("",nrow(mutMat)),labels_col=rep("",ncol(mutMat)))
 ...
 pheatmap(log10(0.01+mutMat),clustering_distance_cols = 'correlation',cellwidth = 10,annotation_col = annotes,labels_row = rep("",nrow(mutMat)),labels_col=rep("",ncol(mutMat)),filename='allMutations.png')
...
print(paste('Missing mutations in genes',paste(missed.genes,collapse=',')))
 ...
 pheatmap(log10(0.01+smutMat),cellheight=10,cellwidth = 10,annotation_col = annotes,labels_col=rep("",ncol(smutMat)),filename='selectedMutations.png')
```
...
topMuts=dplyr::filter(varData,AD>0)%>%
 ...
 pheatmap(log10(0.01+rmutMat),cellheight=10,cellwidth = 10,annotation_col = annotes,labels_col=rep("",ncol(rmutMat)),filename='selectedAndRecMutations.png')
