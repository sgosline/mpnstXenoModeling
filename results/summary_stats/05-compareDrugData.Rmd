...
normalize_toDMSO <- function(mt.dmso, drugID){
    #TODO need to understand pairing of dmso file to mt data
}
dmso.dat<-process_DMSO(syn,mt.dmso)
dmso.stat<- dmso.dat%>%group_by(DrugCol,CellLine)%>%summarize(meanViab=mean(Viabilities))
```
