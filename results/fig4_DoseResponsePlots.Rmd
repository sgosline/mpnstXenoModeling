...
eval.samps<-c('MN2','WU-225','JHU 2-079','JHU 2-031','WU-386')
...
ggsave('SampleMTplots.png',cowplot::plot_grid(plotlist = samp.plots,ncol=2))

drug.plots<-lapply(intersect(eval.drugs,mtDrugData$DrugCol),function(drug) plotMTTreatmentBySample(mt.subs,drug))

ggsave('DrugMTplots.png',cowplot::plot_grid(plotlist = drug.plots,ncol=2))
...
ggsave('SamplePDXplots.png',cowplot::plot_grid(plotlist = plots,ncol=2))
