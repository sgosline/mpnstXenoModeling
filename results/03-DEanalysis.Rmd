...
rnaSeq<<-mpnstXenoModeling::dataFromSynTable(data.tab,syn,'RNASeq')%>%
  ...
  separate(GENEID,into=c('GENE','VERSION'),remove=FALSE)
...
mpnstXenoModeling::plotTopGenesHeatmap(qual_res, dds, pmap,'MTqual',adjpval=0.01, upload=TRUE, parentID='syn25323411')


res<-pmap[rownames(subset(qual_res,padj<0.01)),'GENENAME']%>%doRegularGo()
print(res)
