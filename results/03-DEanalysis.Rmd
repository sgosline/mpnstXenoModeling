...
res=plotOldGSEA(genes.with.values,prot.univ=NULL,prefix='sexDifferences',useEns=FALSE)
...
res=plotOldGSEA(genes.with.values,prot.univ=NULL,prefix='prognosisDiff',useEns=FALSE)
...
plotOldGSEA(genes.with.values,NULL,'ageDifferences',useEns=FALSE)
```
...
plotOldGSEA(genes.with.values,NULL,'MTquality',useEns=FALSE)
