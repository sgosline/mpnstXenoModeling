...
The RNASEq data processing was updated on 9/3/2021 so these functions have also been udpated. 
...
#plotTopGenesHeatmap(sex_res, counts(dds,normalized=TRUE), identifiers,'sex',var.ID, adjpval=0.05, upload=TRUE, parentID='syn25323411')
