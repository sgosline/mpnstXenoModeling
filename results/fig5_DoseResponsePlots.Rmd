...
```{r mutation data, echo=FALSE, message=FALSE, warning=FALSE}
...
eval.samps.inc <- c('MN-2', 'JH-2-079') #other samples available: JHU 2-002, JHU 2-103
```
### Microtissue Metrics
...
lapply(names(drug.list),function(drugGroup){
  ...
  ggsave(paste0('SampleMT',drugGroup,'plots.png'),
         cowplot::plot_grid(plotlist = samp.plots,ncol=2),height=12,width=12)
