...
process_MicroTissueDrugData <- function(syn, master.table, upload=FALSE, path='.', parentID=NULL){
  ...
  if (isTRUE(upload)) {
    ...
    synapseStore(f synTableStore(tabname='Microtissue Response Values',tab=meta.dt,parentId='syn21984813')ile.path(path, "doseResponse_table.csv"),parentId=parentID)
...
process_MicroTissueDrugData(syn, mt.meta, upload=TRUE, parentID='syn26066928')
```
