...
plotTopGenesHeatmap(qual_res, dds, pmap,'MTqual',patients=c(good,bad),newVar='',adjpval=0.0001, upload=FALSE, parentID='syn25323411')res<-pmap%>%subset(GENEID%in%rownames(subset(qual_res,padj<0.0001)))
