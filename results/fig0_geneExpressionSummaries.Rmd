...
plotTopGenesHeatmap(qual_res, dds, pmap,'MTqual',patients=c(good,bad),adjpval=0.0001, upload=FALSE, parentID='syn25323411')
...
mpnstXenoModeling::plotTopGenesHeatmap(qual_res, dds, pmap,'MTqualShrink',patients=c(good,bad),adjpval=0.0001, upload=FALSE, parentID='syn25323411')



res<-pmap[rownames(subset(qual_res,padj<0.0001)),'GENENAME']%>%
  doRegularGo(prefix='MTqualGOShrink')
plot(res)
